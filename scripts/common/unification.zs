...
MetalPress.addRecipe(<immersiveposts:metal_rods:1> * 2, <ore:ingotCopper>, <immersiveengineering:mold:2>, 2400);
...
Crusher.addRecipe(<contenttweaker:crushed_osmium_ore>, <ore:oreOsmium>, 4000);
...
Crusher.removeRecipesForInput(<ore:ingotTitanium>.firstItem);
Crusher.addRecipe(<ore:dustTitanium>.firstItem, <ore:ingotTitanium>, 1600);
...
Crusher.removeRecipe(<immersive_energy:metal:3>);
Crusher.addRecipe(<ore:dustTungsten>.firstItem, <ore:ingotTungsten>, 1600);
MetalPress.removeRecipe(<immersiveintelligence:material_wire>);
MetalPress.removeRecipe(<immersive_energy:material>);
MetalPress.addRecipe(<ore:wireTungsten>.firstItem * 2, <ore:ingotTungsten>, <immersiveengineering:mold:4>, 2400);
MetalPress.removeRecipe(<immersive_energy:metal:7>);
MetalPress.addRecipe(<ore:plateTungsten>.firstItem, <ore:ingotTungsten>, <immersiveengineering:mold>, 2400);
MetalPress.removeRecipe(<immersiveintelligence:material_rod:1>);
MetalPress.addRecipe(<ore:rodTungsten>.firstItem * 2, <ore:ingotTungsten>, <immersiveengineering:mold:2>, 2400);
recipes.remove(<ore:slabSheetmetalTungsten>.firstItem);
recipes.addShaped(<ore:slabSheetmetalTungsten>.firstItem * 6,
 [[null, null, null],
 [<ore:blockTungsten>, <ore:blockTungsten>, <ore:blockTungsten>],
 [null, null, null]]);
recipes.addShaped(<ore:blockTungsten>.firstItem,
 [[null, <ore:slabSheetmetalTungsten>, null],
 [null, <ore:slabSheetmetalTungsten>, null],
 [null, null, null]]);
...
//Zinc
Crusher.removeRecipesForInput(<ore:oreZinc>.firstItem);
Crusher.addRecipe(<contenttweaker:crushed_zinc_ore>, <ore:oreZinc>, 4000);

//Aluminium Magnesium Titanide
...
MetalPress.addRecipe(<ore:sheetCopper>.firstItem, <ore:plateCopper>, <immersiveengineering:mold>, 3600);
