...
<ore:sheetAnnealedCopper>.add(<libvulpes:productsheet:4>);
<ore:rodAnnealedCopper>.add(<libvulpes:productrod:4>);
<ore:stickAnnealedCopper>.addAll(<ore:rodAnnealedCopper>);
...
<ore:basaltSourceAny>.add(<contenttweaker:mega_highland_regolith_volatiles>);
<ore:basaltSourceAny>.add(<contenttweaker:mega_highland_regolith_iron>);
<ore:basaltSourceAny>.add(<contenttweaker:mega_highland_regolith_metals>);
<ore:basaltSourceAny>.add(<contenttweaker:mega_lowland_regolith_volatiles>);
<ore:basaltSourceAny>.add(<contenttweaker:mega_lowland_regolith_iron>);
<ore:basaltSourceAny>.add(<contenttweaker:mega_lowland_regolith_metals>);
<ore:regolithAnyCobblestone>.add(<contenttweaker:mega_highland_regolith_volatiles_cobblestone>);
<ore:regolithAnyCobblestone>.add(<contenttweaker:mega_highland_regolith_iron_cobblestone>);
<ore:regolithAnyCobblestone>.add(<contenttweaker:mega_highland_regolith_metals_cobblestone>);
<ore:regolithAnyCobblestone>.add(<contenttweaker:mega_lowland_regolith_volatiles_cobblestone>);
<ore:regolithAnyCobblestone>.add(<contenttweaker:mega_lowland_regolith_iron_cobblestone>);
<ore:regolithAnyCobblestone>.add(<contenttweaker:mega_lowland_regolith_metals_cobblestone>);
...
<ore:cobblestone>.add(<contenttweaker:mega_highland_regolith_volatiles_cobblestone>);
<ore:cobblestone>.add(<contenttweaker:mega_highland_regolith_iron_cobblestone>);
<ore:cobblestone>.add(<contenttweaker:mega_highland_regolith_metals_cobblestone>);
<ore:cobblestone>.add(<contenttweaker:mega_lowland_regolith_volatiles_cobblestone>);
<ore:cobblestone>.add(<contenttweaker:mega_lowland_regolith_iron_cobblestone>);
<ore:cobblestone>.add(<contenttweaker:mega_lowland_regolith_metals_cobblestone>);
<ore:stone>.add(<contenttweaker:mega_highland_regolith_volatiles>);
<ore:stone>.add(<contenttweaker:mega_highland_regolith_iron>);
<ore:stone>.add(<contenttweaker:mega_highland_regolith_metals>);
<ore:stone>.add(<contenttweaker:mega_lowland_regolith_volatiles>);
<ore:stone>.add(<contenttweaker:mega_lowland_regolith_iron>);
<ore:stone>.add(<contenttweaker:mega_lowland_regolith_metals>);

//ODs for various types of regolith
<ore:rockLowVolatile>.add(<contenttweaker:lowland_regolith_volatiles>);
<ore:rockLowVolatile>.add(<contenttweaker:mega_lowland_regolith_volatiles>);
<ore:rockLowVolatile>.add(<contenttweaker:mega_lowland_regolith_volatiles_cobblestone>);
<ore:rockHighVolatile>.add(<contenttweaker:highland_regolith_volatiles>);
<ore:rockHighVolatile>.add(<contenttweaker:mega_highland_regolith_volatiles>);
<ore:rockHighVolatile>.add(<contenttweaker:mega_highland_regolith_volatiles_cobblestone>);
<ore:rockLowIron>.add(<contenttweaker:lowland_regolith_iron>);
<ore:rockLowIron>.add(<contenttweaker:mega_lowland_regolith_iron>);
<ore:rockLowIron>.add(<contenttweaker:mega_lowland_regolith_iron_cobblestone>);
<ore:rockHighIron>.add(<contenttweaker:highland_regolith_iron>);
<ore:rockHighIron>.add(<contenttweaker:mega_highland_regolith_iron>);
<ore:rockHighIron>.add(<contenttweaker:mega_highland_regolith_iron_cobblestone>);
<ore:rockLowMetals>.add(<contenttweaker:lowland_regolith_metals>);
<ore:rockLowMetals>.add(<contenttweaker:mega_lowland_regolith_metals>);
<ore:rockLowMetals>.add(<contenttweaker:mega_lowland_regolith_metals_cobblestone>);
<ore:rockHighMetals>.add(<contenttweaker:highland_regolith_metals>);
<ore:rockHighMetals>.add(<contenttweaker:mega_highland_regolith_metals>);
<ore:rockHighMetals>.add(<contenttweaker:mega_highland_regolith_metals_cobblestone>);
...
<ore:blockCarbonNanotube>.addAll(<ore:machineCasingGrapheneFiberFlywheelComponent>);
...
<ore:dustGold>.remove(<rustic:dust_gold>);
...
<ore:stoneBasaltAny>.add(<advancedrocketry:basalt>);
...
<ore:oreFluorite>.remove(<immersiveintelligence:ore:4>);
<ore:dustFluorite>.remove(<immersiveintelligence:material_dust:6>);
removeAndHide(<immersiveintelligence:material_dust:6>);
