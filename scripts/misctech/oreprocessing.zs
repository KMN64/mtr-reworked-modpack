...
heated_air.addEnergyPerTickInput(144);
...
steel_magnesium.addFluidInput(<liquid:molteniron> * 1200);
...
cast_iron_ingot.addFluidInput(<liquid:molteniron> * 1200);
...
cast_iron_plate.addFluidInput(<liquid:molteniron> * 1200);
...
cast_iron_rod.addFluidInput(<liquid:molteniron> * 600);
...
//ElectrolyticCrucibleBattery.addRecipe(<liquid:sulfuric_acid> * 1200, null, <liquid:coppersulfatesolutionresidue> * 400, <immersiveengineering:metal:30> * 16, <liquid:coppersulfatesolution> * 1600, 1340000, 400);

//Nickel Processing
var nickel_matte = newBuilder("nickel_matte", "oxygen_converter", 200);
nickel_matte.addEnergyPerTickInput(648);
...
//ElectrolyticCrucibleBattery.addRecipe(<liquid:sulfuric_acid> * 1200, null, <liquid:nickelsulfatesolutionresidue> * 400, <immersiveengineering:metal:34> * 16, <liquid:nickelsulfatesolution> * 1600, 2010000, 400);
...
//ElectrolyticCrucibleBattery.addRecipe(<liquid:sulfuric_acid> * 1600, null, null, <libvulpes:productplate:5> * 16, <liquid:tinsulfatesolution> * 1600, 2010000, 400);
...
Mixer.addRecipe(<liquid:nitricacidhydrochlorideir> * 100, <liquid:nitricacidhydrochloride> * 100, [<ore:dustRichMixedPlatinumGroupMetal>.firstItem], 4000);
Mixer.addRecipe(<liquid:nitricacidhydrochlorideos> * 100, <liquid:nitricacidhydrochloride> * 100, [<ore:dustOsmiumRichMixedPlatinumGroupMetal>.firstItem], 4000);
...
niobium_pentoxide.addEnergyPerTickInput(1008);
