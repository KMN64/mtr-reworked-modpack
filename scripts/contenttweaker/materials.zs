...
static materials as Material[string] = {
    ...
    "Molybdenum" : MaterialSystem.getMaterialBuilder().setName("Molybdenum").setColor(Color.fromHex("7e8084")).build(),
    ...
    "Osmium Rich Mixed Platinum Group Metal" : MaterialSystem.getMaterialBuilder().setName("Osmium Rich Mixed Platinum Group Metal").setColor(Color.fromHex("c6d0d1")).build(),
    ...
    "Mischmetal Chloride" : MaterialSystem.getMaterialBuilder().setName("Mischmetal Chloride").setColor(Color.fromHex("7e8084")).build(),
    ...
    "Tin Derived Anode" : MaterialSystem.getMaterialBuilder().setName("Tin Derived Anode").setColor(Color.fromHex("434347")).build(),
    "Zinc Derived Anode" : MaterialSystem.getMaterialBuilder().setName("Zinc Derived Anode").setColor(Color.fromHex("434347")).build(),
    //Silicon pieces
    ...
    "HDPE Pellet" : MaterialSystem.getMaterialBuilder().setName("HDPE Pellet").setColor(Color.fromHex("ffffff")).build(),
    ...
    "Fission Control Drum": MaterialSystem.getMaterialBuilder().setName("Fission Control Drum").setColor(Color.fromHex("ffffff")).build(),
    ...
    "Graphene Fiber Flywheel Component" : MaterialSystem.getMaterialBuilder().setName("Graphene Fiber Flywheel Component").setColor(Color.fromHex("ffffff")).build(),
...
static parts as string[][string] = {
    ...
    "Maraging Steel" : ["ingot", "plate", "nugget", "dust", "rod", "gear", "wire", "sheet", "scaffoldingpanel", "mechanicalcomponent", "smallpipe", "block", "frame"],
    "Tungstensteel" : ["ingot", "plate", "nugget", "dust", "rod", "scaffoldingpanel", "smallpipe", "block", "frame"],
    "Titanium" : ["scaffoldingpanel", "smallpipe", "wire", "compressorblade", "compressor", "frame"],
    "Aluminium Magnesium Titanide" : ["scaffoldingpanel", "compressorblade" ,"compressor", "frame"],
    "Titanium Nitride" : ["wire"],
    "Titanium Aluminide" : ["ingot", "plate", "nugget", "dust", "rod", "gear", "sheet", "scaffoldingpanel", "frame"],
    "Beryllium" : ["ingot", "nugget", "dust", "scaffoldingpanel", "smallpipe", "frame"],
    ...
    "Molybdenum": ["ingot", "plate", "nugget", "dust", "rod", "wire"],
    ...
    "Osmium Rich Mixed Platinum Group Metal" : ["dust"],
    "Naquadah" : ["dust"],
    //Nonmetal dusts
    "Stone" : ["dustunshaded"],
    ...
    "Tin Derived Anode" : ["sludge"],
    "Zinc Derived Anode" : ["sludge"],
    //Silicon pieces
    ...
    //Circuit bits
    "Raw" : ["processorcrystal", "naquadahprocessorcrystal", "grapheneprocessorcrystal"],
    "Engraved" : ["processorcrystal", "naquadahprocessorcrystal", "grapheneprocessorcrystal"],
    ...
    "HDPE Pellet" : ["metalpressmold", "injectionmold"],
    ...
    //Fission reactor pieces
    "Fission Control Drum": ["machinecasing"],
    ...
    "Graphene Fiber Flywheel Component" : ["machinecasing"],
    //Miscelaneous metal bits
        ...
        for part, String in parts[material] {
            if (parts[material][part].contains(order[type]) && order[type].contains(parts[material][part])) {
                if (material.contains("Coke")) {
                    ...
                    data.addDataValue("harvestLevel", 2);
                } else if (material.contains("Flywheel")) {
                    val data = materials[material].registerPart(order[type]).getData();
