...
osmiridium_ore.setToolLevel(2);
osmiridium_ore.setDropHandler(function(drops, world, position, state, fortune) {
    drops.clear();
    drops.add(<item:contenttweaker:material_part:128> * 2);
    drops.add(<item:contenttweaker:material_part:128> % 50);
    return;
});
osmiridium_ore.register();
...
cinnabar_ore.setDropHandler(function(drops, world, position, state, fortune) {
    drops.clear();
    drops.add(<item:contenttweaker:material_part:171> * 2);
    drops.add(<item:contenttweaker:material_part:171> % 50);
    return;
});
...
fluorite_ore.setDropHandler(function(drops, world, position, state, fortune) {
    drops.clear();
    drops.add(<item:contenttweaker:material_part:167> * 2);
    drops.add(<item:contenttweaker:material_part:167> % 50);
    return;
});
