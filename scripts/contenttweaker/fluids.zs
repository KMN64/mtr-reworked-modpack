...
//create_gas("carbon_dioxide", "FFFFFF");
...
create_fluid("liquid_hydrogen", "EAF7F5", 20, 70, 250);
create_fluid("liquid_methane", "E6E6FF", 90, 1140, 250);
create_fluid("liquid_helium", "E3FFFE", 20, 70, 250);
...
create_fluid("tinsulfatesolutionresidue", "6E6D31", 300, 2000, 1000);
...
//Zinc processing
create_fluid("zincsulfatesolution", "6E6D31", 300, 2000, 1000);
create_fluid("zincsulfatesolutionresidue", "6E6D31", 300, 2000, 1000);
