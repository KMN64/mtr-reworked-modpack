...
Crusher.addRecipe(<contenttweaker:mega_lowland_regolith_volatiles_cobblestone>, <contenttweaker:mega_lowland_regolith_volatiles>, 1600);
Crusher.addRecipe(<contenttweaker:mega_lowland_regolith_iron_cobblestone>, <contenttweaker:mega_lowland_regolith_iron>, 1600);
Crusher.addRecipe(<contenttweaker:mega_lowland_regolith_metals_cobblestone>, <contenttweaker:mega_lowland_regolith_metals>, 1600);
Crusher.addRecipe(<contenttweaker:mega_highland_regolith_volatiles_cobblestone>, <contenttweaker:mega_highland_regolith_volatiles>, 1600);
Crusher.addRecipe(<contenttweaker:mega_highland_regolith_iron_cobblestone>, <contenttweaker:mega_highland_regolith_iron>, 1600);
Crusher.addRecipe(<contenttweaker:mega_highland_regolith_metals_cobblestone>, <contenttweaker:mega_highland_regolith_metals>, 1600);
furnace.addRecipe(<contenttweaker:mega_lowland_regolith_volatiles>, <contenttweaker:mega_lowland_regolith_volatiles_cobblestone>);
furnace.addRecipe(<contenttweaker:mega_lowland_regolith_iron>, <contenttweaker:mega_lowland_regolith_iron_cobblestone>);
furnace.addRecipe(<contenttweaker:mega_lowland_regolith_metals>, <contenttweaker:mega_lowland_regolith_metals_cobblestone>);
furnace.addRecipe(<contenttweaker:mega_highland_regolith_volatiles>, <contenttweaker:mega_highland_regolith_volatiles_cobblestone>);
furnace.addRecipe(<contenttweaker:mega_highland_regolith_iron>, <contenttweaker:mega_highland_regolith_iron_cobblestone>);
furnace.addRecipe(<contenttweaker:mega_highland_regolith_metals>, <contenttweaker:mega_highland_regolith_metals_cobblestone>);
...
//Melting recipes
//Ices
MeltingCrucible.addRecipe(<liquid:distwater> * 1000, <minecraft:ice>, 160);
MeltingCrucible.addRecipe(<liquid:oxygen> * 1000, <contenttweaker:oxygen_ice>, 160);
MeltingCrucible.addRecipe(<liquid:nitrogen> * 1000, <contenttweaker:nitrogen_ice>, 160);
MeltingCrucible.addRecipe(<liquid:methane> * 1000, <contenttweaker:methane_ice>, 160);
MeltingCrucible.addRecipe(<liquid:carbon_dioxide> * 1000, <contenttweaker:carbon_dioxide_ice>, 160);
MeltingCrucible.addRecipe(<liquid:ethylene> * 1000, <contenttweaker:ethene_ice>, 160);
MeltingCrucible.addRecipe(<liquid:ammonia> * 1000, <contenttweaker:ammonia_ice>, 160);
//Sulfur
MeltingCrucible.addRecipe(<liquid:moltensulfur> * 100, <ore:dustSulfur>, 160);
MeltingCrucible.addRecipe(<liquid:moltensulfur> * 800, <contenttweaker:sulfur_dust_block>, 160);
//Planetary rock
MeltingCrucible.addRecipe(<liquid:moltenlowlandvoltaileregolith> * 1000, <ore:rockLowVolatile>, 320);
MeltingCrucible.addRecipe(<liquid:moltenhighlandvoltaileregolith> * 1000, <ore:rockHighVolatile>, 320);
MeltingCrucible.addRecipe(<liquid:moltenlowlandironregolith> * 1000, <ore:rockLowIron>, 320);
MeltingCrucible.addRecipe(<liquid:moltenhighlandironregolith> * 1000, <ore:rockHighIron>, 320);
MeltingCrucible.addRecipe(<liquid:moltenlowlandmetalregolith> * 1000, <ore:rockLowMetals>, 320);
MeltingCrucible.addRecipe(<liquid:moltenhighlandmetalregolith> * 1000, <ore:rockHighMetals>, 320);
