...
Excavator.removeMineral("Bituminous coal");
Excavator.removeMineral("Uranite");
Excavator.removeMineral("Pentlandite");
Excavator.removeMineral("Pentlandite");
Excavator.removeMineral("Petlandite");
Excavator.removeMineral("Chalcopyrite");
Excavator.removeMineral("Beryl");
Excavator.removeMineral("Banded Iron");
Excavator.removeMineral("Auricupride");
Excavator.removeMineral("Alluvial Sift");
Excavator.removeMineral("Rich Auricupride");
Excavator.removeMineral("Laterite");
Excavator.removeMineral("Laterite");
Excavator.removeMineral("Smithsonite");
Excavator.removeMineral("Emerald Geode");
Excavator.removeMineral("Fluorite");
Excavator.removeMineral("Hardened Claypan");
Excavator.removeMineral("Halite");
Excavator.removeMineral("Lazulitic Intrusion");
...
Excavator.addMineral("Halite", 20, 0.1, ["cobblestone", "gravel", "dirt", "oreSalt"], [0.41666666666666, 0.2083333333333333333, 0.041666666666666, 1], [0], false);
//Stones
...
//Sparse (20% ore)
Excavator.addMineral("Platinum", 10, 0.2, ["cobblestone", "gravel", "dirt", "orePlatinum", "oreIridium", "oreOsmium"], [2.5, 1.25, 0.25, 0.5, 0.375, 0.125], [0], false);
...
Excavator.addMineral("Osmiridium", 5, 0.2, ["cobblestone", "gravel", "dirt", "oreOsmiridium", "oreOsmium", "oreIridium"], [2.5, 1.25, 0.25, 0.5, 0.375, 0.125], [0], false);
//Nether
//Medium (40% ore)
...
Excavator.addMineral("Phosphoric Quartzite", 15, 0.4, ["netherrack", "soulsand", "oreQuartz", "orePhosphorus", "oreNetherGold"], [1.25, 0.25, 0.6, 0.3, 0.1], [-1], false);
//End
