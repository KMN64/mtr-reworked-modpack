...
recipes.remove(<immersiveengineering:blueprint>.withTag({blueprint: "solar"}));
recipes.addShaped(<immersiveengineering:blueprint>.withTag({blueprint: "solar"}),
...
Blueprint.addRecipe("solar", <ore:solarPanelItem>.firstItem, [<ore:plateGlass>, <ore:waferLithiumDopedSilicon>, <ore:plateAluminum>]);
Blueprint.addRecipe("solar", <advancedrocketry:satellitepowersource>, [<ore:stickSteel>, <ore:solarPanelItem>, <ore:solarPanelItem>]);
...
Blueprint.addRecipe("solar", <advancedrocketry:solararraypanel>, [<ore:scaffoldingPanelAluminium>, <ore:solarPanelItem>, <ore:solarPanelItem>]);
Blueprint.addRecipe("solar", <advancedrocketry:solarpanel>, [<ore:solarPanelItem>, <ore:plateAluminum>, <libvulpes:structuremachine>]);
Blueprint.addRecipe("solar", <advancedrocketry:solargenerator>, [<ore:solarPanelItem>, <ore:plateAluminum>, <libvulpes:structuremachine>, <libvulpes:battery>]);
...
Blueprint.addRecipe("Specialty Electric Components", <ore:unfilledHighCurrentSuperconductorCableItem>.firstItem, [<ore:sheetSteel>, <ore:sheetSteel>, <ore:wireYttriumBariumCuprate>, <ore:smallPipeMaragingSteel>]);
...
Blueprint.addRecipe("Computers", <retrocomputers:radio>, [<mekanism:basicblock:8>, <advancedrocketry:wirelesstransceiver>, <ore:circuitElite>, <retrocomputers:ribbon_cable>]);
...
Blueprint.addRecipe("Metal Press Secondary Molds", <ore:metalPressMoldHDPEPellet>.firstItem, [<ore:plateSteel>, <ore:plateSteel>, <ore:plateSteel>, <ore:plateSteel>, <ore:plateSteel>, <immersiveengineering:tool:1>]);
...
//Fusion + Particle Containment multiblock components
Blueprint.addRecipe("Fusion Reactor & Particle Containment Components", <ore:machineCasingFusionReactorOuterCasing>.firstItem, [<ore:frameMaragingSteel>, <ore:plateDepletedUraniumDioxide> * 6, <retrocomputers:ribbon_cable> * 24, <ore:circuitElite>]);
Blueprint.addRecipe("Fusion Reactor & Particle Containment Components", <ore:machineCasingFusionReactorInnerCasing>.firstItem, [<ore:frameMaragingSteel>, <ore:plateMolybdenum> * 6, <ore:smallPipeMaragingSteel> * 4, <ore:circuitAdvanced>]);
...
Blueprint.addRecipe("Fusion Reactor & Particle Containment Components", <ore:machineCasingParticleAcceleratorCasing>.firstItem, [<ore:frameMaragingSteel>, <ore:plateMaragingSteel> * 6, <ore:mechanicalComponentMaragingSteel>, <ore:circuitElite>]);
