...
Sieve.addRecipe(<ore:sludgeTinDerivedAnode>.firstItem, <ore:dustTin>.firstItem, 0.4, <ore:dustLead>.firstItem, 0.2, <ore:dustCopper>.firstItem, 0.15, 100, true);
Sieve.addRecipe(<ore:sludgeZincDerivedAnode>.firstItem, <ore:dustLead>.firstItem, 0.3875, <ore:dustSilver>.firstItem, 0.375, <ore:dustZinc>.firstItem, 0.15, 100, true);
...
Sieve.addRecipe(<mekanism:dirtydust:2>, <ore:dustStone>.firstItem, 0.75, <ore:nuggetNickel>.firstItem, 0.75, <ore:dustOsmiumRichMixedPlatinumGroupMetal>.firstItem, 0.1667, 75, true);
...
Sieve.addRecipe(<ore:dustMixedFissileMetals>.firstItem, <ore:dustDepletedUraniumDioxide>.firstItem, 1, <ore:dustLead>.firstItem, 0.3, <ore:dustLead>.firstItem, 0.15, 75, true);
Sieve.addRecipe(<ore:fuelPelletMixedFissileMetals>.firstItem, <ore:dustDepletedUraniumDioxide>.firstItem, 1, <ore:dustDepletedUraniumDioxide>.firstItem, 0.15, <ore:dustLead>.firstItem, 0.15, 75, true);
