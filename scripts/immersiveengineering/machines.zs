...
Refinery.addRecipe(<liquid:ethylene> * 2, <liquid:ethanol> * 2, <liquid:sulfuric_acid> * 1, 180);
...
Distiller.addRecipe(<liquid:sulfuric_acid> * 400, <liquid:tinsulfatesolutionresidue> * 400, <ore:sludgeTinDerivedAnode>.firstItem * 1, 200, 250, 1.0);
Distiller.addRecipe(<liquid:sulfuric_acid> * 400, <liquid:zincsulfatesolutionresidue> * 400, <ore:sludgeZincDerivedAnode>.firstItem * 1, 200, 250, 1.0);
...
BottlingMachine.addRecipe(<ore:injectionMoldHDPEPellet>.firstItem, <ore:metalPressMoldHDPEPellet>.firstItem, <liquid:polyethene> * 75);
...
recipes.addShapeless(<mekanism:polyethene>, [<ore:injectionMoldHDPEPellet>.transformReplace(<ore:metalPressMoldHDPEPellet>.firstItem)]);
...
//BottlingMachine.addRecipe(<ore:etchedWaferIntegratedCircuit>.firstItem, <ore:preparedWaferIntegratedCircuit>, <liquid:sulfuric_acid> * 125);
//BottlingMachine.addRecipe(<ore:etchedWaferCentralProcessingUnit>.firstItem, <ore:preparedWaferCentralProcessingUnit>, <liquid:sulfuric_acid> * 125);
...
MeltingCrucible.addRecipe(<liquid:moltenlithiumchloride> * 100, <ore:dustLithiumChloride>, 40);
MeltingCrucible.addRecipe(<liquid:moltencalciumchloride> * 100, <ore:dustCalciumChloride>, 40);
...
ElectrolyticCrucibleBattery.addRecipe(<liquid:sulfuric_acid> * 1200, null, <liquid:tinsulfatesolutionresidue> * 400, <libvulpes:productplate:5> * 16, <liquid:tinsulfatesolution> * 1600, 1920000, 400);
