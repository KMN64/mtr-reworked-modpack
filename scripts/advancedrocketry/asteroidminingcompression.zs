...
//Nonmetals
//recipes.addShapeless(<ore:dustSilicon>.firstItem * 8, [<contenttweaker:silicon_dioxide_dust_block>]);
...
<ore:dustTungsten>.remove(<immersive_energy:metal:3>);
<ore:dustTungsten>.remove(<immersiveintelligence:material_dust:3>);
